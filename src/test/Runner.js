...
export default async function Run(Test) {
    ...
    // XXX: We do not really care whether --tests was explicitly set. We want
    // to check whether it was set by any means, including implicitly
    // generated configuration. Add a Config API for that?
    const limitedTests = Config.isExplicitlySet("tests");
    ...
    const plannedTests = limitedTests ? Config.tests() : undefined;
